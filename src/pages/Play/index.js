            ...
            <main className="inside-main">
                ...
                <div className='d-flex p-3'>
                    ...
                    <div className='details'>
                        ...
                        <b className='text-muted'>{data.release_date?.split("-")[0] || data.first_air_date?.split("-")[0]}</b>
                        <b className='text-muted d-block'>Rating : {data.vote_average} / 10</b>
                        <p className='d-block text-white'>{data.overview}</p>
                        {(tv && !loading) ? <SeasonsAndEpisodes data={data} season={season} episode={episode} /> : <></>}
                        <br />
                        <hr className='text-muted' />
                        {
                            ...
                            ) : (<Spinner className='d-block m-auto' animation="grow" variant='light' />)
                        }
                    </div>
                </div>
                <Footer />
